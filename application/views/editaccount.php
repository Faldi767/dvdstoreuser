            ...
            <div class="col-lg-3 mt-4 mt-lg-0">
              ...
              <div class="panel panel-default sidebar-menu">
                <div class="panel-heading">
                  <center><img src="<?php echo base_url(); ?>img/product4.jpg" class="img-fluid"></center><br>
                  <center><h3 class="h4 panel-title">Customer Name</h3></center>
                </div>
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="customer-orders.html" class="nav-link"><i class="fa fa-list"></i> My orders</a></li>
                    <li class="nav-item"><a href="customer-account.html" class="nav-link active"><i class="fa fa-user"></i> Edit Account</a></li>
                    <li class="nav-item"><a href="index.html" class="nav-link"><i class="fa fa-sign-out-alt"></i> Logout</a></li>
                  </ul>
                </div>
              </div>
            </div>
